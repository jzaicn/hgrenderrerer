...
// 
// 
// 	for (UINT drawableIndex = 0; drawableIndex < geode->getNumDrawables() ; drawableIndex++)
// 	{
// 		//相当于获取每个 mesh 中的 section
// 		osg::Drawable* drawable = geode->getDrawable(drawableIndex);
...
// 
// 		// get mesh verts
// 		osg::Array* verts = geometry->getVertexArray();
// 
// 		// get mesh section 
// 		ListTriangle listTriangles;
// 		PrimitiveIndexWriter triangleVisitor(geometry, listTriangles, drawableIndex);
...
// 			{
// 				osg::Geometry::ArrayData arr = uvs.at(i);
// 			}
// 		}
// 
// 		//拿材质
...
// 
// 			osg::StateAttribute* attr = geometry->getOrCreateStateSet()->getTextureAttribute(0,osg::StateAttribute::Type::TEXTURE);
// 			if (attr)
// 			{
...
// 						if (image)
// 						{
// 							HGLOG_DEBUG("image: %s ",image->getFileName());
// 						}
// 					}
// 				}
// 			}
...
// 		// 								for (int i = 0; i < indexArr->getNumElements() ; i++)
// 		// 								{
// 		// 								}
// 		// 			 				}
// 
